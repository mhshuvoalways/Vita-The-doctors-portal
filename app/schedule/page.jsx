        ...
        <div className="w-full lg:w-7/12 z-10">
          ...
          <div className="bg-[#F4F6F9] mt-7 rounded-3xl p-5 sm:px-10 sm:py-8">
            ...
            <div className="mt-5 bg-white p-4 sm:py-7 sm:px-14 rounded-3xl">
              <div className="xs:grid-cols-1 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 justify-items-center gap-5">
                {items.map((item) => (
                  <List
                    key={item.id}
                    item={item}
        ...
        {hoverItem && (
          <div className="w-full lg:w-5/12 relative xl:static">
            <Image
              src={NarrowBg}
              alt=""
              className="absolute xl:w-6/12 xl:top-10 right-0 xl:-right-32 bottom-60 xl:bottom-0 z-0"
            />
